...
{
    /// <summary>
    /// Executes the existing Windows batch-based in-place update flow.
    /// Frontends must check <see cref="CanExecute"/> before offering this capability.
    /// </summary>
    public sealed class OpenkhUpdateProceederService : IApplicationUpdateExecutor
    {
